...
cp "${TARGET_DIR}/clide_xml.sh" "./clide_xml.sh"
chmod +x "./clide.sh" "./clide_xml.sh"
echo "   ✓ Copied clide.sh and clide_xml.sh to project root"
...
echo "2. Launch Clide (choose one):"
echo "   ./clide_xml.sh     (XML mode - recommended)"
echo "   ./clide.sh         (standard mode)"
echo ""
